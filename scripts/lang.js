const contents = {
  ...
  "hero-title": {
    en: "Bike Rental and Workshop in Valencia",
    es: "Alquiler de bicis y taller en Valencia",
  },
  "services-page-title": {
  ...
  "about-photo-1-alt": {
    en: "Ono Bikeshop bicycle workshop in Valencia",
    es: "Taller de bicicletas Ono Bikeshop en Valencia",
  },
  "about-photo-2-alt": {
    en: "Bike helmets available at Ono Bikeshop",
    es: "Cascos de bicicleta disponibles en Ono Bikeshop",
  },
  "about-photo-3-alt": {
    en: "Bicycles and accessories at Ono Bikeshop Valencia",
    es: "Bicicletas y accesorios en Ono Bikeshop Valencia",
  },
  "lang-1": {
  ...
  "service-restoration-title": {
    en: "Restoration + detailing",
  ...
  "footer-address": {
    en: "C/ de Guillem de Castro, 64, Ciutat Vella, 46001 València, Valencia, Spain",
    es: "C/ de Guillem de Castro, 64, Ciutat Vella, 46001 València, Valencia, España",
  },
  ...
  "footer-map-box": {
    en: "Google Maps embed coming soon",
    es: "Mapa de Google Maps próximamente",
  },
};
...
function initLang(lang) {
  ...
  for (const node of nodes) {
    const translation = contents[node.id]?.[lang];
